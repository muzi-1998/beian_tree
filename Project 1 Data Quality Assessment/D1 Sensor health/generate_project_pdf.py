...
TREE_LINES = [
    ...
    ("│   ├── mapping.yaml                 # Step mapping: calibrated k=16,x0=0.55", 2),
...
FLOW_LINES = [
    ...
    "       │",
    "       ▼  Mapping (mapping.yaml: injection-calibrated k=16.0, x0=0.55)",
...
CONFIG_LINES = [
    ...
    "    step:    logistic  k=16.0  x0=0.55   [raw-input injection + 10-channel LOCO]",

...
OUTPUT_DIR = D4_ROOT / "outputs" / "integration" / "D4V16_composite_refresh"
MANIFEST_NAME = "D4V16_composite_refresh_manifest.json"
...
def main() -> None:
    ...
    run_id = f"D4V16-COMPOSITE-{hashlib.sha256(run_payload).hexdigest()[:12]}"
    ...
    report = f"""# D4 v1.6 neutral-reference composite refresh

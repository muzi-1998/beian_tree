...
- The isolated Sensitivity Track remains `pending_not_produced` by design; authoritative `D7_forDQR` is produced only by Local admission.
...
- `D7_total` non-null rows: 39648; `D7_forDQR` rows: 39648; D6 interface evaluable rows: 19824.

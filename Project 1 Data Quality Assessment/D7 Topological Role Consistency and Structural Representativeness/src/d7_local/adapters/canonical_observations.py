...
from d7_common.config import D7Paths
from d7_local.contracts import CanonicalInputContract, TrackIsolationGuard


class CanonicalObservationAdapter:
    def __init__(self, paths: D7Paths, sensor_ids: list[str]) -> None:
        self.paths = paths

...
D7_ROOT = Path(__file__).resolve().parents[2]
PROJECT_ROOT = D7_ROOT.parent
...
def resolve_paths() -> D7Paths:
    raw = load_yaml(D7_ROOT / "configs" / "common" / "paths.yaml")
    ...
    return D7Paths(
        ...
        d6_scores=project_path("d6_scores"),

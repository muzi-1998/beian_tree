"""Aggregate D4 evidence without consuming D1 or D2 scores."""
...
from src.d4_physical.scorer import SubScores
...
class D4Aggregator:
    def __init__(self, rules_cfg: dict, mapping_cfg: dict):
        ...
        if not np.isclose(sum(weights.values()), 1.0):
            raise ValueError("D4 aggregation weights must sum to 1.0")

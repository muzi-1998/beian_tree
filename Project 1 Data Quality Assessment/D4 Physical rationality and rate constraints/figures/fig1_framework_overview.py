"""Figure 1: independent D4 evidence and dimensional ownership."""
...
mapping = load_yaml("d4_mapping.yaml")
...
ax.set_title("Independent D4 evidence")
...
ax.set_xticks(range(3), ["D1", "D2", "D4"])

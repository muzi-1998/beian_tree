...
class D5FigureBuilder:
    ...
    def _figure_1(self) -> list[Path]:
        ...
        ax = axes[1]
        status = self._subset("FigD5_1_framework", "b").sort_values("value")
        ...
        ax = axes[2]
        gates = self._subset("FigD5_1_framework", "c").sort_values("order")
        ...
        annotation_labels = {
            ...
            "D5_raw retained when calculable": "D5 raw retained\nwhen calculable",
        }
    ...
    def _figure_2(self) -> list[Path]:
        ...
        heat = self._subset("FigD5_2_spatiotemporal", "a")
        ...
        ax.set_title("Daily lower-quartile D5 raw score")
        colorbar = fig.colorbar(image, ax=ax, fraction=0.018, pad=0.015)
        colorbar.set_label("D5 raw (1-5)")
        self._boxed(ax)
        self._panel_label(ax, "a")

        ax = fig.add_subplot(grid[1, 0])
        distribution = self._subset("FigD5_2_spatiotemporal", "b")
        data = []
        ...
        ax.set_ylabel("D5 raw (1-5)")
        ax.set_title("Score distribution by analyte")
        self._boxed(ax)
        self._panel_label(ax, "b")

        ax = fig.add_subplot(grid[1, 1])
        support = self._subset("FigD5_2_spatiotemporal", "c")
        analytes = ["DO", "ORP"]
        bottom = np.zeros(2)
    ...
    def _figure_3(self) -> list[Path]:
        ...
        colors = {
            "D5_raw": "#222222", "Q_profile": "#168AAD", "Q_gradient": "#E76F51",
        ...
        ax = fig.add_subplot(grid[1, 1])
        consensus = self._subset("FigD5_3_evidence", "c").sort_values("value")
        ...
        ax.set_title("D5-to-D4 zone-consensus labels")
        self._boxed(ax)
        self._panel_label(ax, "c")
    ...
    def _figure_5(self) -> list[Path]:
        ...
        ax.set_title("D4 numeric independence audit")

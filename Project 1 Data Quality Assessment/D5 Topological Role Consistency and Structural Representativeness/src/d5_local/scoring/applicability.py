...
class ApplicabilityGate:
    ...
    def apply(self, frame: pd.DataFrame) -> pd.DataFrame:
        ...
        missing = required_scores.isna().any(axis=1) | output["D5_raw"].isna()
        ...
        output["D5_report_provisional"] = output["D5_raw"].where(report_ready)
        output["D5_report"] = output["D5_raw"].where(research_report_ready)
        output["D5_total"] = output["D5_raw"].where(score_ready)
        output["D5_report_score"] = output["D5_total"]

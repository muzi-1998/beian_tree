...
- `Q` (quality) and `E` (evidence completeness) are always reported separately.
- Full and availability-aware estimands are never interpreted as exchangeable.
...
QA results are recorded under `outputs/aggregation_v2/`.
